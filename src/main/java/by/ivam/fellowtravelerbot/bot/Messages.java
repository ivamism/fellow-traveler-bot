...
//    Creation new request
    ...
    private final String BOOKING_CANCEL_MESSAGE = "Другая сторона отказалась от бронирования. Высылаю вам список других вариантов:\n";
    ...
    private final String CREATE_RIDE_MESSAGE = "Поездка создана или изменена";
    private final String RIDE_MESSAGE = "Поездка создана или изменена:\n%s";
}
